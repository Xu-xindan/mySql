...
//        query("计算机系2019级1班");
    ...
    public static List<Info> query(String name) {
        ...
        try {
            ...
            // 创建数据库连接
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?user=root&password=0325&useUnicode=true&characterEncoding=UTF-8&useSSL=false");
...
//select cls.name,stu.sn,stu.name,stu.qq_mail,cou.name,sco.score  from
//classes cs,student stu,course cou,score sco where cls.id=stu.classes_id and
//stu.id=sco.student_id and cou.id=sco.course_id and cls.name='计算机系2019级1班'
